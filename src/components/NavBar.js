    ...
    return (
        ...
        ">
            ...
            <nav className="flex items-center justify-center flex-wrap">
                ...
                <motion.a href="https://github.com/ShifanaSShfk" target={"_blank"}
                whileHover={{y:-2}}
                whileTap={{scale:0.9}}
                className="w-6 mx-3"
                >
                ...
                <motion.a href="https://www.linkedin.com/in/shifana-s-shafeek-6b176b254/" target={"_blank"}
                whileHover={{y:-2}}
                whileTap={{scale:0.9}}
                className="w-6 mx-3"
                >
                ...
                <motion.a href="https://www.linkedin.com/in/shifana-s-shafeek-6b176b254/" 
                target={"_blank"}
                whileHover={{y:-2}}
                whileTap={{scale:0.9}}
            ...
            
           {
            ...
            <div className='absolute left-[50%] top-2 tramslate-x-[-50%]'>
                <Logo />
            </div>
        </header>
    )
